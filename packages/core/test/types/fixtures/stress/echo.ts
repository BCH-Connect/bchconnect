/**
 * Echo, a stress protocol for scale tests. Weighted like a real protocol:
...
export interface Echo extends ProtocolDefinition {
	id: "echo";
	session: EchoSessionData;
	methods: {
		echo_method1: {
			params: {
	...
	capability: "echo-cap1" | "echo-cap2" | "echo-cap3" | "echo-cap4";
}

export declare function echo(config?: { endpoint?: string }): Connector<Echo>;
