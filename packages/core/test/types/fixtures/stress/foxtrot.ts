/**
 * Foxtrot, a stress protocol for scale tests. Weighted like a real protocol:
...
export interface FoxtrotSessionData {
...
export interface Foxtrot extends ProtocolDefinition {
	id: "foxtrot";
	session: FoxtrotSessionData;
	methods: {
		foxtrot_method1: {
			params: {
	...
	capability: "foxtrot-cap1" | "foxtrot-cap2" | "foxtrot-cap3" | "foxtrot-cap4";
}

export declare function foxtrot(config?: {
	endpoint?: string;
}): Connector<Foxtrot>;
