/**
 * Delta, a stress protocol for scale tests. Weighted like a real protocol:
...
export interface DeltaSessionData {
...
export interface Delta extends ProtocolDefinition {
	id: "delta";
	session: DeltaSessionData;
	methods: {
		delta_method1: {
			params: {
	...
	capability: "delta-cap1" | "delta-cap2" | "delta-cap3" | "delta-cap4";
}

export declare function delta(config?: { endpoint?: string }): Connector<Delta>;
