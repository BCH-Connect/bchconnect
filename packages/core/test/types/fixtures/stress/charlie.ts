/**
 * Charlie, a stress protocol for scale tests. Weighted like a real protocol:
...
export interface CharlieSessionData {
...
export interface Charlie extends ProtocolDefinition {
	id: "charlie";
	session: CharlieSessionData;
	methods: {
		charlie_method1: {
			params: {
	...
	capability: "charlie-cap1" | "charlie-cap2" | "charlie-cap3" | "charlie-cap4";
}

export declare function charlie(config?: {
	endpoint?: string;
}): Connector<Charlie>;
